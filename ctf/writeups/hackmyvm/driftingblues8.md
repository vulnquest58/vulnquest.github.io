---
layout: page
title: "Driftingblues8 - HackMyVM Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/hackmyvm/driftingblues8/
platform: hackmyvm
machine_name: "Driftingblues8"
difficulty: Easy
os: Linux
---
...
<div class="hmv-info-card">
  <div class="hmv-card-header">
    <div class="htb-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="Driftingblues8" class="hmv-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
        <h3 class="hmv-machine-title">Driftingblues8</h3>
...
> [!NOTE]
> This writeup details the complete attack path for the **Driftingblues8** machine on the **HackMyVM** platform.
