...
<div class="hmv-info-card">
  <div class="hmv-card-header">
    <div class="hmv-header-left">
      <img src="{{ '/assets/images/machines/boxing.png' | relative_url }}" alt="Boxing" class="hmv-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
...
> [!NOTE]
> This writeup details the complete attack path for the **Boxing** machine on the **HackMyVM** platform.
