---
layout: page
title: "UnbakedPie - HackMyVM Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/hackmyvm/unbakedpie/
platform: hackmyvm
machine_name: "UnbakedPie"
difficulty: Hard
os: Linux
---
...
<div class="hmv-info-card">
  <div class="hmv-card-header">
    <div class="htb-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="UnbakedPie" class="hmv-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
        <h3 class="hmv-machine-title">UnbakedPie</h3>
...
> [!NOTE]
> This writeup details the complete attack path for the **UnbakedPie** machine on the **HackMyVM** platform.
