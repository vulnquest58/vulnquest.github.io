---
layout: page
title: "TriplAdvisor - HackMyVM Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🪟 Windows"
permalink: /ctf/writeups/hackmyvm/tripladvisor/
platform: hackmyvm
machine_name: "TriplAdvisor"
difficulty: Easy
os: Windows
---
...
<div class="hmv-info-card">
  <div class="hmv-card-header">
    <div class="hmv-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="TriplAdvisor" class="hmv-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
        <h3 class="hmv-machine-title">TriplAdvisor</h3>
  ...
  <div class="hmv-meta-row" style="grid-template-columns: repeat(4, 1fr);">
    ...
    <div class="hmv-meta-col">
      ...
      <span class="hmv-meta-val">🪟 Windows</span>
    </div>
    <div class="hmv-meta-col">
...
> [!NOTE]
> This writeup details the complete attack path for the **TriplAdvisor** machine on the **HackMyVM** platform.
