...
<div class="hmv-info-card">
  <div class="hmv-card-header">
    <div class="hmv-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="Thirteen" class="hmv-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
        <h3 class="hmv-machine-title">Thirteen</h3>
...
> [!NOTE]
> This writeup details the complete attack path for the **Thirteen** machine on the **HackMyVM** platform.
