---
layout: page
title: "Driftingblues5 - HackMyVM Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/hackmyvm/driftingblues5/
platform: hackmyvm
machine_name: "Driftingblues5"
difficulty: Easy
os: Linux
---
...
<div class="hmv-info-card">
  <div class="hmv-card-header">
    <div class="hmv-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="Driftingblues5" class="hmv-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
        <h3 class="hmv-machine-title">Driftingblues5</h3>
...
> [!NOTE]
> This writeup details the complete attack path for the **Driftingblues5** machine on the **HackMyVM** platform.
