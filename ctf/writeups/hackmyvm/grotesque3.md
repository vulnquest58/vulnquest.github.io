---
layout: page
title: "Grotesque3 - HackMyVM Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/hackmyvm/grotesque3/
platform: hackmyvm
machine_name: "Grotesque3"
difficulty: Easy
os: Linux
---
...
<div class="hmv-info-card">
  <div class="hmv-card-header">
    <div class="hmv-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="Grotesque3" class="hmv-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
        <h3 class="hmv-machine-title">Grotesque3</h3>
...
> [!NOTE]
> This writeup details the complete attack path for the **Grotesque3** machine on the **HackMyVM** platform.
