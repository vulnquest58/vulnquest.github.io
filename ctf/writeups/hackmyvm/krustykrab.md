---
layout: page
title: "Krustykrab - HackMyVM Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/hackmyvm/krustykrab/
platform: hackmyvm
machine_name: "Krustykrab"
difficulty: Medium
os: Linux
---
...
<div class="hmv-info-card">
  <div class="hmv-card-header">
    <div class="htb-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="Krustykrab" class="hmv-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
        <h3 class="hmv-machine-title">Krustykrab</h3>
...
> [!NOTE]
> This writeup details the complete attack path for the **Krustykrab** machine on the **HackMyVM** platform.
