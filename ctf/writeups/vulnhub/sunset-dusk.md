---
layout: page
title: "SUNSET_DUSK - VulnHub Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/vulnhub/sunset-dusk/
platform: vulnhub
machine_name: "SUNSET_DUSK"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **SUNSET_DUSK** machine on the **VulnHub** platform.
