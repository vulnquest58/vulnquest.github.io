---
layout: page
title: "Cofeeaddicts - VulnHub Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/vulnhub/cofeeaddicts/
platform: vulnhub
machine_name: "Cofeeaddicts"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Cofeeaddicts** machine on the **VulnHub** platform.
