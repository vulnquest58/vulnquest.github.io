---
layout: page
title: "ColddBoxEasy_EN - VulnHub Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/vulnhub/colddboxeasy-en/
platform: vulnhub
machine_name: "ColddBoxEasy_EN"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **ColddBoxEasy_EN** machine on the **VulnHub** platform.
