---
layout: page
title: "Funbox_Lunchbreaker - VulnHub Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/vulnhub/funbox-lunchbreaker/
platform: vulnhub
machine_name: "Funbox_Lunchbreaker"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Funbox_Lunchbreaker** machine on the **VulnHub** platform.
