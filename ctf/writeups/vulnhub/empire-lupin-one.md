---
layout: page
title: "Empire Lupin One - VulnHub Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/vulnhub/empire-lupin-one/
platform: vulnhub
machine_name: "Empire Lupin One"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Empire Lupin One** machine on the **VulnHub** platform.
