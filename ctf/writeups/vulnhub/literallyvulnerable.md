---
layout: page
title: "LiterallyVulnerable - VulnHub Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/vulnhub/literallyvulnerable/
platform: vulnhub
machine_name: "LiterallyVulnerable"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **LiterallyVulnerable** machine on the **VulnHub** platform.
