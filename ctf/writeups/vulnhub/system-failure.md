---
layout: page
title: "System_failure - VulnHub Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/vulnhub/system-failure/
platform: vulnhub
machine_name: "System_failure"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **System_failure** machine on the **VulnHub** platform.
