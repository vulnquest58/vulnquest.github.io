---
layout: page
title: "Gigachad_vh - VulnHub Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/vulnhub/gigachad-vh/
platform: vulnhub
machine_name: "Gigachad_vh"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Gigachad_vh** machine on the **VulnHub** platform.
