---
layout: page
title: "EVILBOX_ONE - VulnHub Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/vulnhub/evilbox-one/
platform: vulnhub
machine_name: "EVILBOX_ONE"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **EVILBOX_ONE** machine on the **VulnHub** platform.
