...
permalink: /ctf/writeups/vulnhub/moneybox/
platform: vulnhub
machine_name: "MoneyBox"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **MoneyBox** machine on the **VulnHub** platform.
