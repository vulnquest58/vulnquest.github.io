---
layout: page
title: "Challenge Webhooks - CTF's Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/challenges/ctfs/challenge-webhooks/
platform: ctf's
machine_name: "Challenge Webhooks"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Challenge Webhooks** machine on the **CTF's** platform.
