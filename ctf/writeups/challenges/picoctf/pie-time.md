---
layout: page
title: "PIE TIME - PicoCTF Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/challenges/picoctf/pie-time/
platform: picoctf
machine_name: "PIE TIME"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **PIE TIME** machine on the **PicoCTF** platform.
