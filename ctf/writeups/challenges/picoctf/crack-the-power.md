...
permalink: /ctf/writeups/challenges/picoctf/crack-the-power/
platform: picoctf
machine_name: "Crack the Power"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Crack the Power** machine on the **PicoCTF** platform.
