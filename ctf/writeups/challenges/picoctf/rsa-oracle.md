---
layout: page
title: "Rsa_oracle - PicoCTF Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/challenges/picoctf/rsa-oracle/
platform: picoctf
machine_name: "Rsa_oracle"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Rsa_oracle** machine on the **PicoCTF** platform.
