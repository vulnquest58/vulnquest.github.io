---
layout: page
title: "Flag Hunters - PicoCTF Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/challenges/picoctf/flag-hunters/
platform: picoctf
machine_name: "Flag Hunters"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Flag Hunters** machine on the **PicoCTF** platform.
