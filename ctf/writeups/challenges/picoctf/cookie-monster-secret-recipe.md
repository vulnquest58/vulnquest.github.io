---
layout: page
title: "Cookie Monster Secret Recipe - PicoCTF Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/challenges/picoctf/cookie-monster-secret-recipe/
platform: picoctf
machine_name: "Cookie Monster Secret Recipe"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Cookie Monster Secret Recipe** machine on the **PicoCTF** platform.
