---
layout: page
title: "First Grep - PicoCTF Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/challenges/picoctf/first-grep/
platform: picoctf
machine_name: "First Grep"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **First Grep** machine on the **PicoCTF** platform.
