---
layout: page
title: "Hashcrack - PicoCTF Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/challenges/picoctf/hashcrack/
platform: picoctf
machine_name: "Hashcrack"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Hashcrack** machine on the **PicoCTF** platform.
