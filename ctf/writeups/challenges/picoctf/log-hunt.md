---
layout: page
title: "Log Hunt - PicoCTF Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/challenges/picoctf/log-hunt/
platform: picoctf
machine_name: "Log Hunt"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Log Hunt** machine on the **PicoCTF** platform.
