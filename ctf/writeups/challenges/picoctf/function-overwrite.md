---
layout: page
title: "function overwrite - PicoCTF Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/challenges/picoctf/function-overwrite/
platform: picoctf
machine_name: "function overwrite"
difficulty: Hard
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **function overwrite** machine on the **PicoCTF** platform.
