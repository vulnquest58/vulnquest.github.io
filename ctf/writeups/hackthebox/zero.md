---
layout: page
title: "Zero - Hack The Box Writeup"
...
<div class="htb-info-card">
  <div class="htb-card-header">
    <div class="htb-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="Zero" class="htb-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
...
> [!NOTE]
> This writeup details the complete attack path for the **Zero** machine on the **HackTheBox** platform.
