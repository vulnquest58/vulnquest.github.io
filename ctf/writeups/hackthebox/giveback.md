---
layout: page
title: "Giveback - Hack The Box Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/hackthebox/giveback/
platform: hackthebox
machine_name: "Giveback"
difficulty: Medium
os: Linux
---
...
<div class="htb-info-card">
  <div class="htb-card-header">
    <div class="htb-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="Giveback" class="htb-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
        <h3 class="htb-machine-title">Giveback</h3>
...
> [!NOTE]
> This writeup details the complete attack path for the **Giveback** machine on the **HackTheBox** platform.
