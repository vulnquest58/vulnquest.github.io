...
layout: page
title: "HTB: Guardian"
subtitle: "hackthebox ctf htb-guardian nmap linux hard feroxbuster php upload sudo-l linpeas..."
permalink: /ctf/writeups/hackthebox/guardian/
platform: hackthebox
machine_name: "Guardian"
difficulty: Hard
os: Linux
---

hackthebox ctf htb-guardian hackthebox ctf htb-guardian nmap linux hard feroxbuster php upload sudo-l linpeas
...
**Guardian** is a hard 🐧 Linux machine hosted on Hack The Box. This guide covers the complete step-by-step walkthrough detailing reconnaissance, foothold exploitation, and privilege escalation vectors to compromise the host.
