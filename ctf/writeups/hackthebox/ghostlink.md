---
layout: page
title: "Ghostlink - Hack The Box Writeup"
...
<div class="htb-info-card">
  <div class="htb-card-header">
    <div class="htb-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="Ghostlink" class="htb-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
        <h3 class="htb-machine-title">Ghostlink</h3>
...
> [!NOTE]
> This writeup details the complete attack path for the **Ghostlink** machine on the **HackTheBox** platform.
