...
layout: page
title: "HTB: Bamboo"
subtitle: "hackthebox ctf htb-bamboo nmap linux medium feroxbuster php upload sudo-l linpeas..."
permalink: /ctf/writeups/hackthebox/bamboo/
platform: hackthebox
machine_name: "Bamboo"
difficulty: Medium
os: Linux
...
hackthebox ctf htb-bamboo hackthebox ctf htb-bamboo nmap linux medium feroxbuster php upload sudo-l linpeas
...
**Bamboo** is a medium 🐧 Linux machine hosted on Hack The Box. This guide covers the complete step-by-step walkthrough detailing reconnaissance, foothold exploitation, and privilege escalation vectors to compromise the host.
