...
subtitle: "hackthebox ctf htb-perfection nmap linux easy feroxbuster php upload sudo-l linpeas..."
permalink: /ctf/writeups/hackthebox/perfection/
platform: hackthebox
machine_name: "Perfection"
difficulty: Easy
os: Linux
---

hackthebox ctf htb-perfection hackthebox ctf htb-perfection nmap linux easy feroxbuster php upload sudo-l linpeas
...
**Perfection** is a easy 🐧 Linux machine hosted on Hack The Box. This guide covers the complete step-by-step walkthrough detailing reconnaissance, foothold exploitation, and privilege escalation vectors to compromise the host.
