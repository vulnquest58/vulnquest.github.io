---
layout: page
title: "Cobblestone - Hack The Box Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/hackthebox/cobblestone/
platform: hackthebox
machine_name: "Cobblestone"
difficulty: Insane
os: Linux
---
...
<div class="htb-info-card">
  <div class="htb-card-header">
    <div class="htb-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="Cobblestone" class="htb-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
        <h3 class="htb-machine-title">Cobblestone</h3>
  ...
  <div class="htb-meta-row" style="grid-template-columns: repeat(4, 1fr);">
    <div class="htb-meta-col">
      ...
      <span class="htb-meta-val green">20 Jun 2025</span>
    </div>
    <div class="htb-meta-col">
...
> [!NOTE]
> This writeup details the complete attack path for the **Cobblestone** machine on the **HackTheBox** platform.
