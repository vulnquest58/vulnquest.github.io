...
layout: page
title: "HTB: Forgotten"
subtitle: "hackthebox ctf htb-forgotten nmap linux easy feroxbuster php upload sudo-l linpeas..."
permalink: /ctf/writeups/hackthebox/forgotten/
platform: hackthebox
machine_name: "Forgotten"
difficulty: Easy
os: Linux
---

hackthebox ctf htb-forgotten hackthebox ctf htb-forgotten nmap linux easy feroxbuster php upload sudo-l linpeas
...
**Forgotten** is a easy 🐧 Linux machine hosted on Hack The Box. This guide covers the complete step-by-step walkthrough detailing reconnaissance, foothold exploitation, and privilege escalation vectors to compromise the host.
