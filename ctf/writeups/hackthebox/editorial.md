...
layout: page
title: "HTB: Editorial"
subtitle: "hackthebox ctf htb-editorial nmap linux easy feroxbuster php upload sudo-l linpeas..."
permalink: /ctf/writeups/hackthebox/editorial/
platform: hackthebox
machine_name: "Editorial"
difficulty: Easy
os: Linux
---

hackthebox ctf htb-editorial hackthebox ctf htb-editorial nmap linux easy feroxbuster php upload sudo-l linpeas
...
**Editorial** is a easy 🐧 Linux machine hosted on Hack The Box. This guide covers the complete step-by-step walkthrough detailing reconnaissance, foothold exploitation, and privilege escalation vectors to compromise the host.
