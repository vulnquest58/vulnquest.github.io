...
layout: page
title: "HTB: Manage"
subtitle: "hackthebox ctf htb-manage nmap linux easy feroxbuster php upload sudo-l linpeas..."
permalink: /ctf/writeups/hackthebox/manage/
platform: hackthebox
machine_name: "Manage"
difficulty: Easy
os: Linux
...
hackthebox ctf htb-manage hackthebox ctf htb-manage nmap linux easy feroxbuster php upload sudo-l linpeas
...
**Manage** is a easy 🐧 Linux machine hosted on Hack The Box. This guide covers the complete step-by-step walkthrough detailing reconnaissance, foothold exploitation, and privilege escalation vectors to compromise the host.
