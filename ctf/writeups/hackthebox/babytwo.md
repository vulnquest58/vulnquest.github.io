...
layout: page
title: "HTB: BabyTwo"
subtitle: "hackthebox ctf htb-babytwo nmap windows medium active-directory netexec evil-winrm bloodhound hashcat..."
permalink: /ctf/writeups/hackthebox/babytwo/
platform: hackthebox
machine_name: "BabyTwo"
difficulty: Medium
os: Windows
---

hackthebox ctf htb-babytwo hackthebox ctf htb-babytwo nmap windows medium active-directory netexec evil-winrm bloodhound hashcat
...
**BabyTwo** is a medium 🪟 Windows machine hosted on Hack The Box. This guide covers the complete step-by-step walkthrough detailing reconnaissance, foothold exploitation, and privilege escalation vectors to compromise the host.
