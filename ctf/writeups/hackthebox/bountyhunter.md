...
<div class="htb-info-card">
  <div class="htb-card-header">
    <div class="htb-header-left">
      <img src="{{ page.avatar_url | default: ('/assets/images/machines/' | append: page.machine_name | downcase | replace: ' ', '-' | replace: '_', '-' | append: '.png') | relative_url }}" alt="BountyHunter" class="htb-avatar-glow" onerror="this.src='{{ '/assets/images/logo.png' | relative_url }}';" />
      <div>
        <h3 class="htb-machine-title">BountyHunter</h3>
  ...
  <div class="htb-meta-row" style="grid-template-columns: repeat(4, 1fr);">
    ...
    <div class="htb-meta-col">
      ...
      <span class="htb-meta-val" style="font-family: monospace; font-size: 0.95rem;">10.10.11.100</span>
    </div>
    <div class="htb-meta-col">
...
> [!NOTE]
> This writeup details the complete attack path for the **BountyHunter** machine on the **HackTheBox** platform.
