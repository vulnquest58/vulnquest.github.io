---
layout: page
title: "ShadowBlocks - Vulnyx Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /ctf/writeups/vulnyx/shadowblocks/
platform: vulnyx
machine_name: "ShadowBlocks"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **ShadowBlocks** machine on the **Vulnyx** platform.
