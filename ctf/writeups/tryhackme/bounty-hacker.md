...
permalink: /ctf/writeups/tryhackme/bounty-hacker/
platform: tryhackme
machine_name: "Bounty Hacker"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Bounty Hacker** machine on the **TryHackMe** platform.
