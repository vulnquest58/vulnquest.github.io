---
layout: page
title: "Bashpariencias - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/bashpariencias/
platform: dockerlabs
machine_name: "Bashpariencias"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Bashpariencias** machine on the **DockerLabs** platform.
