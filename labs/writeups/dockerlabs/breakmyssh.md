---
layout: page
title: "BreakMySSH - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/breakmyssh/
platform: dockerlabs
machine_name: "BreakMySSH"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **BreakMySSH** machine on the **DockerLabs** platform.
