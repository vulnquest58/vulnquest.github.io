---
layout: page
title: "SECorNOTsec - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/secornotsec/
platform: dockerlabs
machine_name: "SECorNOTsec"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **SECorNOTsec** machine on the **DockerLabs** platform.
