---
layout: page
title: "Insecure - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/insecure/
platform: dockerlabs
machine_name: "Insecure"
difficulty: Hard
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Insecure** machine on the **DockerLabs** platform.
