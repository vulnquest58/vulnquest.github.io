---
layout: page
title: "Ciberguard - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/ciberguard/
platform: dockerlabs
machine_name: "Ciberguard"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Ciberguard** machine on the **DockerLabs** platform.
