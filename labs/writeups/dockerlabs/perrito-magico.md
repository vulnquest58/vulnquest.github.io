---
layout: page
title: "Perrito Magico - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/perrito-magico/
platform: dockerlabs
machine_name: "Perrito Magico"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Perrito Magico** machine on the **DockerLabs** platform.
