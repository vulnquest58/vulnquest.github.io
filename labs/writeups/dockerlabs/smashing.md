---
layout: page
title: "Smashing - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/smashing/
platform: dockerlabs
machine_name: "Smashing"
difficulty: Hard
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Smashing** machine on the **DockerLabs** platform.
