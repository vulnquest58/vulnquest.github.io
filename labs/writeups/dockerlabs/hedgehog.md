---
layout: page
title: "Hedgehog - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/hedgehog/
platform: dockerlabs
machine_name: "Hedgehog"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Hedgehog** machine on the **DockerLabs** platform.
