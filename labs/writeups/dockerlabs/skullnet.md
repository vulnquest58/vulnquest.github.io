---
layout: page
title: "Skullnet - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/skullnet/
platform: dockerlabs
machine_name: "Skullnet"
difficulty: Hard
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Skullnet** machine on the **DockerLabs** platform.
