---
layout: page
title: "ApacheByte - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/apachebyte/
platform: dockerlabs
machine_name: "ApacheByte"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **ApacheByte** machine on the **DockerLabs** platform.
