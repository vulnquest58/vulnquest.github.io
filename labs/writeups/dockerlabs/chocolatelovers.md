---
layout: page
title: "ChocolateLovers - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/chocolatelovers/
platform: dockerlabs
machine_name: "ChocolateLovers"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **ChocolateLovers** machine on the **DockerLabs** platform.
