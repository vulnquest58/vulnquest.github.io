---
layout: page
title: "Inclusion - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/inclusion/
platform: dockerlabs
machine_name: "Inclusion"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Inclusion** machine on the **DockerLabs** platform.
