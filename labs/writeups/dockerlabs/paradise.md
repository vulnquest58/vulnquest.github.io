---
layout: page
title: "Paradise - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/paradise/
platform: dockerlabs
machine_name: "Paradise"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Paradise** machine on the **DockerLabs** platform.
