---
layout: page
title: "WhereIsMyWebShell - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/whereismywebshell/
platform: dockerlabs
machine_name: "WhereIsMyWebShell"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **WhereIsMyWebShell** machine on the **DockerLabs** platform.
