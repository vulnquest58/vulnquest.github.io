---
layout: page
title: "Chocolatefire - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/chocolatefire/
platform: dockerlabs
machine_name: "Chocolatefire"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Chocolatefire** machine on the **DockerLabs** platform.
