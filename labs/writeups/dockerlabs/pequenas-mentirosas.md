---
layout: page
title: "Pequenas-mentirosas - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/pequenas-mentirosas/
platform: dockerlabs
machine_name: "Pequenas-mentirosas"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Pequenas-mentirosas** machine on the **DockerLabs** platform.
