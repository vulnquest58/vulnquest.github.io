---
layout: page
title: "MachuPicchu - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/machupicchu/
platform: dockerlabs
machine_name: "MachuPicchu"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **MachuPicchu** machine on the **DockerLabs** platform.
