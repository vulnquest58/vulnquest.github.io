...
permalink: /labs/writeups/dockerlabs/apibase/
platform: dockerlabs
machine_name: "ApiBase"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **ApiBase** machine on the **DockerLabs** platform.
