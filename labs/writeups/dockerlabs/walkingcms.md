---
layout: page
title: "WalkingCMS - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/walkingcms/
platform: dockerlabs
machine_name: "WalkingCMS"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **WalkingCMS** machine on the **DockerLabs** platform.
