---
layout: page
title: "Buscalove - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/buscalove/
platform: dockerlabs
machine_name: "Buscalove"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Buscalove** machine on the **DockerLabs** platform.
