---
layout: page
title: "SummerVibes - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/summervibes/
platform: dockerlabs
machine_name: "SummerVibes"
difficulty: Hard
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **SummerVibes** machine on the **DockerLabs** platform.
