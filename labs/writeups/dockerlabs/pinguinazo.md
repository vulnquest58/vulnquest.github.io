---
layout: page
title: "Pinguinazo - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/pinguinazo/
platform: dockerlabs
machine_name: "Pinguinazo"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Pinguinazo** machine on the **DockerLabs** platform.
