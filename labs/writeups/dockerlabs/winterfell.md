---
layout: page
title: "Winterfell - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/winterfell/
platform: dockerlabs
machine_name: "Winterfell"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Winterfell** machine on the **DockerLabs** platform.
