---
layout: page
title: "Anonymouspingu - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/anonymouspingu/
platform: dockerlabs
machine_name: "Anonymouspingu"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Anonymouspingu** machine on the **DockerLabs** platform.
