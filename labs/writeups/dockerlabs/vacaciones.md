---
layout: page
title: "Vacaciones - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/vacaciones/
platform: dockerlabs
machine_name: "Vacaciones"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Vacaciones** machine on the **DockerLabs** platform.
