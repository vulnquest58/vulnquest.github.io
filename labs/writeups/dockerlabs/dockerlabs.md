---
layout: page
title: "Dockerlabs - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/dockerlabs/
platform: dockerlabs
machine_name: "Dockerlabs"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Dockerlabs** machine on the **DockerLabs** platform.
