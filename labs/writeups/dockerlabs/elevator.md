---
layout: page
title: "Elevator - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/elevator/
platform: dockerlabs
machine_name: "Elevator"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Elevator** machine on the **DockerLabs** platform.
