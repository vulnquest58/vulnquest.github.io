---
layout: page
title: "Pntopntobarra - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/pntopntobarra/
platform: dockerlabs
machine_name: "Pntopntobarra"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Pntopntobarra** machine on the **DockerLabs** platform.
