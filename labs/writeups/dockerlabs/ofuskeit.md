---
layout: page
title: "Ofuskeit - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/ofuskeit/
platform: dockerlabs
machine_name: "Ofuskeit"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Ofuskeit** machine on the **DockerLabs** platform.
