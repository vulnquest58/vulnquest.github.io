---
layout: page
title: "Obsession - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/obsession/
platform: dockerlabs
machine_name: "Obsession"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Obsession** machine on the **DockerLabs** platform.
