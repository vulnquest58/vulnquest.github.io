---
layout: page
title: "Balulero - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/balulero/
platform: dockerlabs
machine_name: "Balulero"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Balulero** machine on the **DockerLabs** platform.
