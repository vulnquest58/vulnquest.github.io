---
layout: page
title: "Internship - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/internship/
platform: dockerlabs
machine_name: "Internship"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Internship** machine on the **DockerLabs** platform.
