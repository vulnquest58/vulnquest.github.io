---
layout: page
title: "ChocoPing - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/chocoping/
platform: dockerlabs
machine_name: "ChocoPing"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **ChocoPing** machine on the **DockerLabs** platform.
