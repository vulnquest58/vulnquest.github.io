---
layout: page
title: "NightBlade - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/nightblade/
platform: dockerlabs
machine_name: "NightBlade"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **NightBlade** machine on the **DockerLabs** platform.
