---
layout: page
title: "StrongJenkins - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/strongjenkins/
platform: dockerlabs
machine_name: "StrongJenkins"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **StrongJenkins** machine on the **DockerLabs** platform.
