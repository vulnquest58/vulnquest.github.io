---
layout: page
title: "Insanity - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/insanity/
platform: dockerlabs
machine_name: "Insanity"
difficulty: Hard
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Insanity** machine on the **DockerLabs** platform.
