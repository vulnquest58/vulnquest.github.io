---
layout: page
title: "DockHackLab - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/dockhacklab/
platform: dockerlabs
machine_name: "DockHackLab"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **DockHackLab** machine on the **DockerLabs** platform.
