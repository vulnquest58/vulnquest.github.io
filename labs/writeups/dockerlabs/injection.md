---
layout: page
title: "Injection - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/injection/
platform: dockerlabs
machine_name: "Injection"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Injection** machine on the **DockerLabs** platform.
