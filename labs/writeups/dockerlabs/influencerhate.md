---
layout: page
title: "InfluencerHate - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/influencerhate/
platform: dockerlabs
machine_name: "InfluencerHate"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **InfluencerHate** machine on the **DockerLabs** platform.
