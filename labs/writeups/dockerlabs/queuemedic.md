---
layout: page
title: "Queuemedic - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/queuemedic/
platform: dockerlabs
machine_name: "Queuemedic"
difficulty: Hard
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Queuemedic** machine on the **DockerLabs** platform.
