---
layout: page
title: "Vendetta - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/vendetta/
platform: dockerlabs
machine_name: "Vendetta"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Vendetta** machine on the **DockerLabs** platform.
