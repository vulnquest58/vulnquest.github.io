---
layout: page
title: "Crystalteam - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/crystalteam/
platform: dockerlabs
machine_name: "Crystalteam"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Crystalteam** machine on the **DockerLabs** platform.
