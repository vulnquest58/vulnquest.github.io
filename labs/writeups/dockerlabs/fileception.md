---
layout: page
title: "Fileception - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/fileception/
platform: dockerlabs
machine_name: "Fileception"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Fileception** machine on the **DockerLabs** platform.
