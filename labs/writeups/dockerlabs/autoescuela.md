---
layout: page
title: "Autoescuela - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/autoescuela/
platform: dockerlabs
machine_name: "Autoescuela"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Autoescuela** machine on the **DockerLabs** platform.
