---
layout: page
title: "Usersearch - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/usersearch/
platform: dockerlabs
machine_name: "Usersearch"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Usersearch** machine on the **DockerLabs** platform.
