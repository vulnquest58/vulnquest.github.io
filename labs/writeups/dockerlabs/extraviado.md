---
layout: page
title: "Extraviado - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/extraviado/
platform: dockerlabs
machine_name: "Extraviado"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Extraviado** machine on the **DockerLabs** platform.
