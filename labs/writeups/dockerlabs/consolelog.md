---
layout: page
title: "ConsoleLog - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/consolelog/
platform: dockerlabs
machine_name: "ConsoleLog"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **ConsoleLog** machine on the **DockerLabs** platform.
