---
layout: page
title: "Ejotapete - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/ejotapete/
platform: dockerlabs
machine_name: "Ejotapete"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Ejotapete** machine on the **DockerLabs** platform.
