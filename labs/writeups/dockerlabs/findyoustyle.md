---
layout: page
title: "FindYouStyle - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/findyoustyle/
platform: dockerlabs
machine_name: "FindYouStyle"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **FindYouStyle** machine on the **DockerLabs** platform.
