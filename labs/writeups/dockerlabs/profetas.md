---
layout: page
title: "Profetas - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/profetas/
platform: dockerlabs
machine_name: "Profetas"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Profetas** machine on the **DockerLabs** platform.
