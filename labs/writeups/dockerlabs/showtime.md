---
layout: page
title: "ShowTime - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/showtime/
platform: dockerlabs
machine_name: "ShowTime"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **ShowTime** machine on the **DockerLabs** platform.
