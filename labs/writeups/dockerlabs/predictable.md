---
layout: page
title: "Predictable - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/predictable/
platform: dockerlabs
machine_name: "Predictable"
difficulty: Hard
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Predictable** machine on the **DockerLabs** platform.
