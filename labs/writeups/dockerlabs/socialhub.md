---
layout: page
title: "SocialHub - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/socialhub/
platform: dockerlabs
machine_name: "SocialHub"
difficulty: Hard
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **SocialHub** machine on the **DockerLabs** platform.
