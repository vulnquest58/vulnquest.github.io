---
layout: page
title: "Rolarola - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/rolarola/
platform: dockerlabs
machine_name: "Rolarola"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Rolarola** machine on the **DockerLabs** platform.
