---
layout: page
title: "Forgotten_portal - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/forgotten-portal/
platform: dockerlabs
machine_name: "Forgotten_portal"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Forgotten_portal** machine on the **DockerLabs** platform.
