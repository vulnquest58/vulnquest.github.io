---
layout: page
title: "NodeClimb - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/nodeclimb/
platform: dockerlabs
machine_name: "NodeClimb"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **NodeClimb** machine on the **DockerLabs** platform.
