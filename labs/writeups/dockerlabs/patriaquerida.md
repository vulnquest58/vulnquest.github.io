---
layout: page
title: "Patriaquerida - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/patriaquerida/
platform: dockerlabs
machine_name: "Patriaquerida"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Patriaquerida** machine on the **DockerLabs** platform.
