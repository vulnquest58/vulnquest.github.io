---
layout: page
title: "Hackpenguin - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/hackpenguin/
platform: dockerlabs
machine_name: "Hackpenguin"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Hackpenguin** machine on the **DockerLabs** platform.
