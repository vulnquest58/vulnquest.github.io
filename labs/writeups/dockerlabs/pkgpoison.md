---
layout: page
title: "Pkgpoison - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/pkgpoison/
platform: dockerlabs
machine_name: "Pkgpoison"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Pkgpoison** machine on the **DockerLabs** platform.
