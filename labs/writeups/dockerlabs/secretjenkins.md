---
layout: page
title: "SecretJenkins - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/secretjenkins/
platform: dockerlabs
machine_name: "SecretJenkins"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **SecretJenkins** machine on the **DockerLabs** platform.
