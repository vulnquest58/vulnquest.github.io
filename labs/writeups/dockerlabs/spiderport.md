---
layout: page
title: "SpiderPort - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/spiderport/
platform: dockerlabs
machine_name: "SpiderPort"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **SpiderPort** machine on the **DockerLabs** platform.
