---
layout: page
title: "Firsthacking - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/firsthacking/
platform: dockerlabs
machine_name: "Firsthacking"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Firsthacking** machine on the **DockerLabs** platform.
