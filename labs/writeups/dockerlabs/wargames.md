...
permalink: /labs/writeups/dockerlabs/wargames/
platform: dockerlabs
machine_name: "Wargames"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Wargames** machine on the **DockerLabs** platform.
