---
layout: page
title: "Hiddencat - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/hiddencat/
platform: dockerlabs
machine_name: "Hiddencat"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Hiddencat** machine on the **DockerLabs** platform.
