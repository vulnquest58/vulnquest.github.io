---
layout: page
title: "Stranger - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/stranger/
platform: dockerlabs
machine_name: "Stranger"
difficulty: Medium
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Stranger** machine on the **DockerLabs** platform.
