---
layout: page
title: "Balufood - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/balufood/
platform: dockerlabs
machine_name: "Balufood"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Balufood** machine on the **DockerLabs** platform.
