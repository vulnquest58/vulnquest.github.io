---
layout: page
title: "Picadilly - DockerLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/dockerlabs/picadilly/
platform: dockerlabs
machine_name: "Picadilly"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **Picadilly** machine on the **DockerLabs** platform.
