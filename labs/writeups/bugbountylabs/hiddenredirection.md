---
layout: page
title: "HiddenRedirection - BugBountyLabs Writeup"
subtitle: "Complete walkthrough detailing reconnaissance, foothold, and privilege escalation on 🐧 Linux"
permalink: /labs/writeups/bugbountylabs/hiddenredirection/
platform: bugbountylabs
machine_name: "HiddenRedirection"
difficulty: Easy
os: Linux
---
...
> [!NOTE]
> This writeup details the complete attack path for the **HiddenRedirection** machine on the **BugBountyLabs** platform.
